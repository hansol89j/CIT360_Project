package ApplicationControlPattern.DogApplicationControllPattern.DogExecuteACP;

import ApplicationControlPattern.DogApplicationControllPattern.Dog.Dog;
import ApplicationControlPattern.DogApplicationControllPattern.Dog.DogsBrain;
            ...
            try{
                ...
                if (wishedCommand < 1 || wishedCommand > 4){
                    ...
                    if(askUserToRepeat() == false) {
                        try {
                            System.out.println("All Commands handled Through ApplicationControlPattern\n");
